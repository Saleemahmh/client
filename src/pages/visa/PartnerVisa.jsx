...
const PartnerVisa = () => {
  return (
    ...
    <h1 className="text-3xl font-bold mt-15 text-center mb-2 bg-gradient-to-r from-yellow-700 via-amber-200 to-yellow-300 bg-clip-text text-transparent">Partner Visa</h1>
