...
const Home = () => {
  return (
    <div>
      {/*    Floating Calculator */}
      <button className="fixed lg:bottom-6 bottom-35 right-10 z-999 lg:right-15 bg-gradient-to-br from-blue-600 to-indigo-950 text-amber-200 p-4 rounded-full shadow-lg hover:scale-110 hover:rotate-12 transition-transform duration-300 ease-in-out">
        <Link to="/calculatorhub">
      ...
      >
        <div className="flex flex-col md:flex-rows items-center justify-between text-center md:text-left px-6 py-5 rounded-xl bg-indigo-500/10 backdrop-blur-md shadow-md border border-indigo/20 gap-y-4 md:gap-x-6">
          <h1 className="text-sm md:block hidden sm:text-base md:text-lg lg:text-xl bg-gradient-to-r from-yellow-900 via-amber-200 to-yellow-700 bg-clip-text text-transparent">
