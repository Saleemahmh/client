...
return(
    <>
<nav className={`bg-transparent font-amarante text-amber-200 fixed lg:w-full md:w-[750px] w-[335px] md:ml-0 ml-4 mt-5 top-0 z-50 transition-colors duration-300 ${scrolled? "text-indigo-950" : "text-amber-200"}`}>
