        ...
        >
            ...
            {premiumServices.map((premiumService, index) => (
              <SwiperSlide key={index}>
                ...
                <div className="flex items-center justify-center pt-4 w-full max-w-sm min-h-[420px]">
                ...
                <div className="bg-indigo-950 text-amber-100 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 h-full flex flex-col justify-between text-center border border-gray-100 shadow-[0_4px_30px_rgba(245,158,11,0.5)] hover:scale-105">
                  ...
                  <motion.button
  className="flex justify-center items-center text-center h-[45px] w-full sm:w-[180px] md:w-[160px] mx-auto cursor-pointer rounded-full bg-gradient-to-r from-yellow-900 via-amber-200 to-yellow-300"
  whileHover={{ scale: 1.1 }}
  transition={{ type: "spring", stiffness: 400, damping: 10 }}
>
  <Link className="text-base sm:text-lg font-amarante my-2 text-indigo-950" to="/register">
    Learn More
  </Link>
</motion.button>
